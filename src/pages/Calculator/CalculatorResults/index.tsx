...
import "./index.scss";
import { HeroPortrait } from "../CalculatorHeroPicker/HeroPortrait";
import {
  formatAttribute,
...
import type { CalculatorResultsProps } from "@/types/calculator";
                ...
                <div className="calculator-result-showcase">
                  ...
                  {hero?.id ? (
                    <div className="calculator-result-showcase-hero">
                      <HeroPortrait hero={{ id: hero.id, name: hero.name }} />
                    </div>
                  ) : null}
                </div>
              </section>

...
import { CalculatorRangeField } from "../CalculatorRangeField/CalculatorRangeField";

type PanelField = { key: PanelConstraintKey; label: string; suffix?: string };
type ExtraField = {
...
type CalculatorConstraintsState = {
  running: boolean;
...
type CalculatorConstraintsOptions = {
...
type CalculatorConstraintsActions = {
...
type CalculatorConstraintsCommands = {
...
type CalculatorConstraintsProps = {

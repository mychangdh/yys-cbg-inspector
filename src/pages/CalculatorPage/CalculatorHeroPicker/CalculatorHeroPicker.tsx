...
type CalculatorHeroPickerState = {
  open: boolean;
  search: string;
...
type CalculatorHeroPickerOptions = {
...
type CalculatorHeroPickerActions = {
  onSearchChange: (value: string) => void;
  onSelect: (hero: CalculatorHeroOption) => void;
};

type CalculatorHeroPickerCommands = {
  onClose: () => void;
};

type CalculatorHeroPickerProps = {
